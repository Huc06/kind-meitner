# kind-meitner Contributor License Agreement

This agreement covers contributions to the `enterprise/` directory of the
kind-meitner repository, which is licensed under the kind-meitner Enterprise
...
1. **Copyright license.** You grant Milind Soni ("the Project Owner") and
   ...
   under any license, including the kind-meitner Enterprise License and the
   Apache License 2.0.
