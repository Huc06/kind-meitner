...
export default defineConfig({
  ...
  server: {
    ...
    host: "127.0.0.1",
    port: Number(process.env.KIND_MEITNER_UI_PORT) || 5199,
    ...
    proxy: {
      "/api": {
        target: `http://127.0.0.1:${process.env.KIND_MEITNER_PORT || process.env.OGB_PORT || 8799}`,
      },
      "/.well-known/kind-meitner/environment": {
        target: `http://127.0.0.1:${process.env.KIND_MEITNER_PORT || process.env.OGB_PORT || 8799}`,
      },
    },
  },
