...
kind-meitner's store, provider adapters, MCP bridge and UI components; no new
...
Adapt the interaction patterns to existing KindMeitner components. If copying
