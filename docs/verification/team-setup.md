...
The real renderer was driven through `control:kind-meitner ui` in an isolated fixture:
...
`/tmp/kind-meitner-live-team-0913.MwRY2k/setup-gpt-5.6-luna-1789255036346/result.json`.
