...
offline CLI. It sends actual messages through `control-kind-meitner`, waits for settled
...
in `.kind-meitner-scratch/verify-evidence/model-switch/`. This proves settings and turn
...
unrequested coaching sent by kind-meitner; live results confirm ordinary work, explicit
