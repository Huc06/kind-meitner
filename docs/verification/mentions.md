...
node --experimental-strip-types scripts/control-kind-meitner.ts channels --url http://127.0.0.1:20657
node --experimental-strip-types scripts/control-kind-meitner.ts wait --channel 18b5bfe7-deb0-4962-b3b4-414e9ab90492 --timeout 60 --url http://127.0.0.1:20657
node --experimental-strip-types scripts/control-kind-meitner.ts messages --channel 18b5bfe7-deb0-4962-b3b4-414e9ab90492 --limit 20 --url http://127.0.0.1:20657
```

Printed log:
`%TEMP%/kind-meitner-verification-evidence/server-1788957885515-22688.log`.
...
```sh
node --experimental-strip-types scripts/verify-mentions.ts
node --experimental-strip-types scripts/control-kind-meitner.ts channels --url http://127.0.0.1:21621
...
node --experimental-strip-types scripts/control-kind-meitner.ts wait --channel ec952c04-4e41-4a13-ba87-8c79b3137c05 --timeout 60 --url http://127.0.0.1:21621
node --experimental-strip-types scripts/control-kind-meitner.ts messages --channel ec952c04-4e41-4a13-ba87-8c79b3137c05 --limit 20 --url http://127.0.0.1:21621
```

The printed server log was
`%TEMP%/kind-meitner-verification-evidence/server-1788790736762-24868.log`.
...
```sh
node --experimental-strip-types scripts/verify-mentions.ts --bot-mentions
node --experimental-strip-types scripts/control-kind-meitner.ts channels --url http://127.0.0.1:21580
# In the printed previewUrl, fill the channel composer with
# @Atlas Please ask the team to review.
# and press Enter.
node --experimental-strip-types scripts/control-kind-meitner.ts wait --channel 2ee9e176-5270-4211-9968-af5baa0eef39 --timeout 60 --url http://127.0.0.1:21580
node --experimental-strip-types scripts/control-kind-meitner.ts messages --channel 2ee9e176-5270-4211-9968-af5baa0eef39 --limit 20 --url http://127.0.0.1:21580
```

Recorded on 2026-09-07; printed log:
`%TEMP%/kind-meitner-verification-evidence/server-1788791336713-2520.log`.
