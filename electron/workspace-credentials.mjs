...
export const WORKSPACE_CREDENTIALS = [
  ...
  { section: "tts", field: "key", name: "ttsKey", env: "KIND_MEITNER_TTS_KEY" },
  { section: "imageGen", field: "key", name: "openaiImageApiKey", env: "KIND_MEITNER_OPENAI_IMAGE_KEY" },
  { section: "imageGen", field: "customApiKey", name: "customImageApiKey", env: "KIND_MEITNER_CUSTOM_IMAGE_KEY" },
