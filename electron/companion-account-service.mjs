...
export const DEFAULT_COMPANION_CONTROL_PLANE_URL = "https://accounts.kind-meitner.com";
...
const INSTALLATION_CREDENTIAL = /^kind_meitner_install_[A-Za-z0-9_-]{22}\.[A-Za-z0-9_-]{43}$/;
...
export function resolveCompanionControlPlaneURL({
  ...
  if (Object.hasOwn(environment, "KIND_MEITNER_CONTROL_PLANE_URL")) {
    return normalizeControlPlaneURL(environment.KIND_MEITNER_CONTROL_PLANE_URL);
  }
...
const FRIENDLY_MESSAGES = Object.freeze({
  ...
  network_unavailable: "kind-meitner could not reach its secure connection service. Check your internet and try again.",
