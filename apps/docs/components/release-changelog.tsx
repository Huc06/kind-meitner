...
const RELEASE_REPOSITORIES = [
  'harrymove-ctrl/kind-meitner',
  'harrymove-ctrl/kind-meitner-releases',
] as const;
const RELEASES_PER_PAGE = 100;
const MAX_RELEASE_PAGES = 10;
const LEGACY_DRAFT_NOTES =
  /^Draft assembled by the release workflow from milind-soni\/kind-meitner@([0-9a-f]{40})\. Edit these notes, then publish\.\s*$/i;
...
function releaseNotes(release: GitHubRelease) {
  ...
  return `This build predates curated release notes. [View its source commit (${commit.slice(0, 7)})](https://github.com/harrymove-ctrl/kind-meitner/commit/${commit}).`;
}
  ...
  if (releases.length === 0) {
    return (
      <p>
        ...
        <a href="https://github.com/harrymove-ctrl/kind-meitner/releases">Browse releases on GitHub</a>.
      </p>
    );
  }
