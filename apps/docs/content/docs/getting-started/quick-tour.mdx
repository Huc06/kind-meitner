---
title: Quick tour
description: Learn the six parts of kind-meitner before handing your first job to an agent.
icon: Map
---
...
<ProductScreenshot name="docs-model-picker" alt="kind-meitner model picker showing cloud and local agent engines" caption="Models are selected per bot, so a team can mix engines without changing global settings." />
