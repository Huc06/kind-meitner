...
Open **Connected apps** from the sidebar, choose a service, and complete its authorization in your normal browser. kind-meitner turns the resulting connection into tools that supported agent engines can use.
