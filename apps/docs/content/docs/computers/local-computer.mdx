...
Local control is off by default. The Electron main process owns the bundled CUA driver lifecycle so operating-system permissions are attributed to kind-meitner rather than a background helper.
