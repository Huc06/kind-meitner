# kind-meitner harness server — hosted/self-hosted tenant image.
#
...
RUN npm install -g agent-browser@${AGENT_BROWSER_VERSION} \
  && HOME=/opt/kind-meitner-browser agent-browser install \
  && ln -s /opt/kind-meitner-browser/.agent-browser/browsers/chrome-*/chrome /opt/kind-meitner-browser/chrome \
