// Real Claude CLI through the kind-meitner driver, synthetic account and loopback API.
...
const home = mkdtempSync(join(tmpdir(), "kind-meitner-claude-auth-fixture-"));
...
process.env = {
  ...
  PATH: process.env.PATH, KIND_MEITNER_DATA_DIR: join(home, "kind-meitner"),
