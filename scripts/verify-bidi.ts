...
const scratch = mkdtempSync(join(tmpdir(), "kind-meitner-verify-bidi-"));
...
try {
  ...
  ui = await mountPreview(fixture, {
    entry: "/scripts/testing/threads-preview.tsx", route: "/__bidi.html", title: "Isolated KindMeitner Bidi",
  });
