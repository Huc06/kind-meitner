...
if (!bundledSource.includes("KIND_MEITNER_CUA_SDK_LIBRARY")) {
  console.error("staged cua-sdk.mjs lacks the KIND_MEITNER_CUA_SDK_LIBRARY resolver patch — re-run pnpm build:cua:win");
  process.exit(1);
}

process.env.KIND_MEITNER_CUA_SDK_LIBRARY = dll;
...
const host = new sdk.EmbeddedCuaDriverHost(binary, "com.kind-meitner.app");
try {
