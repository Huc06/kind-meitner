...
export async function stageBrowserTarget(root, target, { cacheDirectory = process.env.KIND_MEITNER_BROWSER_ARCHIVE_DIR ?? join(root, "dist-native", "browser-archives") } = {}) {
  const spec = browserBundleSpec(target);
