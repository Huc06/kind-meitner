...
const IMAGE = process.env.KIND_MEITNER_DEB_SMOKE_IMAGE || "ubuntu:24.04";
const RUNTIME = process.env.KIND_MEITNER_DEB_SMOKE_RUNTIME || "docker";
...
const staged = "/root/pending dir/o'brien/kind-meitner.deb";
...
const installed = inContainer(
  [
    ...
    'test -x /opt/kind-meitner/kind-meitner && echo "EXECUTABLE=yes"',
  ].join("\n"),
);
