...
const prefix = "kind-meitner-cua-x11-input-";
...
const title = `kind-meitner CUA input safety ${process.pid}`;
const xev = spawn(
  "xev",
...
try {
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "kind-meitner-x11-input-smoke", version: "1" },
  });
  ...
  const session = `kind-meitner-x11-smoke-${process.pid}`;
  assertToolResult(
