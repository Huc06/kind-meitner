    ...
    try {
      ...
      throw new Error(
        `Running \`pnpm gen:bodies\` failed while checking the catalogs for drift. ` +
          ...
          `\`git status\` / \`git diff -- shared/mascot-bodies.ts ios/Sources/CompanionCore/MausBodies.swift android/app/src/main/kotlin/com/kind-meitner/companion/ui/MausBodies.kt\` ` +
