...
const resources = process.env.KIND_MEITNER_CUA_RESOURCES ?? join(root, "dist-native", hostArch);
process.env.KIND_MEITNER_CUA_SDK_LIBRARY = join(resources, "cua-sdk/native/libcua_driver_sdk.dylib");
...
const host = new EmbeddedCuaDriverHost(binary, "com.kind-meitner.app");
let proxy;
...
try {
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "kind-meitner-package-smoke", version: "1" },
  });
