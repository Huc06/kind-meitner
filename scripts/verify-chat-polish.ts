...
try {
  ...
  writeFileSync(wrapper, [
    ...
    `process.env.FAKE_CLAUDE_TOOL_CALLS = ${JSON.stringify(JSON.stringify([
      { name: "Bash", input: { command: "pnpm control:kind-meitner doctor", password: "fixture-password" }, output: { text: "All fixture health checks passed.", token: "fixture-token" }, ok: true },
  ...
  ui = await mountPreview(fixture, { entry: "/scripts/testing/threads-preview.tsx", route: "/__chat-polish.html", title: "Isolated kind-meitner UI polish" });
