...
const __APP_VERSION__: string;
  ...
  interface Window {
    ogb?: {
      ...
      /** Receives a GitHub package URL opened through kind-meitner://install. */
      ...
      /** Opens a live desktop as a sandboxed window owned by kind-meitner. */
      desktopViewer?: {
      ...
      /** Asks where to save a bot-created file (inside ~/.kind-meitner), copies
