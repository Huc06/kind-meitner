...
export function CallTargetButton({
  ...
  const reason = !capabilitiesReady
    ...
    : !capabilities.dictation.available
      ? "Calls require kind-meitner for macOS because speech recognition runs on-device."
      : !window.ogb?.speechStart
        ? "The speech service is unavailable in this app build. Restart or update kind-meitner."
        : !configured
