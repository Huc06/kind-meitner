...
export function ConnectedWorkspacesSettings() {
  ...
  return <>
    ...
    <Card title="Connect hosted workspace" subtitle="Already running kind-meitner on a VPS, server, or another computer? Connect it here.">
      <form className="flex flex-col gap-3" onSubmit={(event) => {
        ...
        <details className="text-[12px] text-ink-secondary"><summary className="cursor-pointer">Need a pairing code?</summary>
          ...
          <code className="mt-1 block select-all break-words rounded-md bg-inset px-2 py-2 text-ink">npx kind-meitner pair --label "My desktop"</code>
        </details>
