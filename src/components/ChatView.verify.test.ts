...
const run: Message[] = [
  ...
  chip("c1", "pnpm control:kind-meitner doctor --url http://127.0.0.1:8799", true),
  chip("c2", "node --experimental-strip-types scripts/control-kind-meitner.ts send --bot x --text hi", false),
  chip("c3", "git status", true),
  chip("c4", "cat scripts/control-kind-meitner.ts", true),
];
