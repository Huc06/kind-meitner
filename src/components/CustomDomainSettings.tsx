...
export function CustomDomainGuide({ status }: { status: CustomDomainStatus }) {
  return (
    <details className="rounded-lg border border-hairline/50 bg-inset px-3 py-2.5 text-[12px] text-ink-secondary">
      ...
      <a className="mt-3 inline-flex items-center gap-1.5 text-accent hover:underline" href="https://github.com/harrymove-ctrl/kind-meitner/blob/main/docs/self-hosting.md#connect-a-custom-domain-in-settings" target="_blank" rel="noopener noreferrer">
