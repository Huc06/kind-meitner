...
const KEY = "kind-meitner-drafts";
const ATTACHMENTS_KEY = "kind-meitner-draft-attachments";
const SEND_IDS_KEY = "kind-meitner-draft-send-ids";
const CHANNEL_MODES_KEY = "kind-meitner-draft-channel-modes";
