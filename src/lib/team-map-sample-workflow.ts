...
export function buildSampleWorkflowEvents(mapping: BotRoleMapping = DEFAULT_BOT_ROLES): WorkflowEvent[] {
  ...
  const events: WorkflowEvent[] = [
    ...
    // Beat 8: Results become Ready for review
    {
      ...
      artifact: {
        ...
        taskId: "task-discovery",
        authorAgentId: disc,
        assignedReviewerId: rev,
        reviewState: "approved",
        status: "verified",
        contentPreview: "{\n  \"vendor\": \"Vendor Orion Ltd.\",\n  \"tier\": \"Tier-1 Verified ASP\",\n  \"reputationScore\": 98.4,\n  \"fulfillmentRate\": \"99.1%\",\n  \"disputeCount90d\": 0,\n  \"depositAddress\": \"0x821c...34f9\"\n}",
      },
    },
    {
      type: "artifact_submitted",
      ...
      artifact: {
        ...
        type: "code",
        sizeBytes: 8900,
        summary: "72h escrow lockup with auto-release upon delivery",
        createdAt: t(62),
        taskId: "task-escrow",
        authorAgentId: escrow,
        assignedReviewerId: rev,
    ...
    },
    {
      ...
      artifact: {
        ...
        type: "spec",
        sizeBytes: 12400,
        summary: "Terms v1: 250 units at 420 USDT/unit, 48h settlement (Superseded)",
        createdAt: t(63),
        taskId: "task-terms",
        authorAgentId: coach,
        assignedReviewerId: rev,
        ...
        status: "completed",
        contentPreview: "# Commercial Purchase Agreement v1\n- Buyer: OKX Treasury\n- Vendor: Orion Industrial\n- Lot size: 250 units @ 420 USDT\n- Inspection window: 48 hours [Flagged by Spend Scout]",
      },
    },
    {
    ...
    },
    {
      ...
      artifact: {
        ...
        reviewState: "approved",
        status: "verified",
        contentPreview: "# Commercial Agreement v2 (Remediated)\n- Inspection window: 72 hours\n- Escrow vault: 0x48a...99e\n- Hardware test receipt clause included\n- Reviewer sign-off: Spend Scout (PASSED)",
      },
    },
    {
      type: "artifact_submitted",
      ...
      authorAgentId: rev,
      artifact: {
        id: "art-trust-card-spend",
        name: "spend-scout-treasury-cert.json",
        type: "receipt",
        sizeBytes: 3100,
        summary: "Spend Scout trust verification card & 105k USDT cap clearance",
        createdAt: t(85),
        taskId: "task-terms",
        authorAgentId: rev,
        assignedReviewerId: rev,
        reviewState: "approved",
        status: "verified",
        contentPreview: "{\n  \"gatekeeper\": \"Spend Scout\",\n  \"status\": \"GO\",\n  \"treasuryCapUSDT\": 105000,\n  \"counterpartyRiskScore\": \"LOW\",\n  \"multisigApproval\": true\n}",
      },
    },
    {
      type: "artifact_submitted",
      ...
      authorAgentId: rev,
      artifact: {
        id: "art-sanctions-flag",
        name: "counterparty-risk-audit.json",
        type: "data",
        sizeBytes: 5400,
        summary: "Sanction screening & on-chain clustering audit for seller payout address",
        createdAt: t(86),
        taskId: "task-terms",
        authorAgentId: rev,
        assignedReviewerId: rev,
        reviewState: "under_review",
        status: "in_progress",
        contentPreview: "{\n  \"screeningTarget\": \"0x821c...34f9\",\n  \"ofacMatch\": false,\n  \"clusteringRisk\": \"LOW\",\n  \"flaggedEvents\": 0,\n  \"recommendation\": \"ALLOW_PROCEED\"\n}",
      },
    },
    {
      type: "task_progress",
