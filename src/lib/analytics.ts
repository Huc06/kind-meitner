...
const OPT_OUT_KEY = "kind-meitner-analytics-opt-out";
...
export function initAnalytics() {
  ...
  if (!localStorage.getItem("kind-meitner-installed")) {
    localStorage.setItem("kind-meitner-installed", new Date().toISOString());
...
const GATE_KEY = "kind-meitner-email-gate";
