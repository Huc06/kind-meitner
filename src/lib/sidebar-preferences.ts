...
export const SIDEBAR_DENSITY_KEY = "kind-meitner.sidebarDensity";
export const SIDEBAR_COLLAPSED_SECTIONS_KEY = "kind-meitner.sidebarCollapsedSections.v1";
export const SIDEBAR_SECTION_ORDER_KEY = "kind-meitner.sidebarSectionOrder.v1";
