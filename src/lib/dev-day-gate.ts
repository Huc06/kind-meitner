...
export const DEV_DAY_GATE_STARTERS = [
  ...
  {
    // 13837 is delisted: okx.ai returns 404, so its trust card is NO_GO on
    // listing_page alone. 13851 is the live canonical ASP, which is what the
    // GO half of the gate demo needs.
    id: "trust-13851",
