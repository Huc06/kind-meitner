...
export const GROUP_GOAL_CONTROL_OPEN = "<kind-meitner-goal>";
export const GROUP_GOAL_CONTROL_CLOSE = "</kind-meitner-goal>";
...
export function groupGoalWorkerInstructions(args: {
  ...
  return [
    ...
    `Address your result to ${args.coordinatorName}. Do not invent a new orchestration protocol or emit a kind-meitner-goal control envelope.`,
  ].join("\n");
}
