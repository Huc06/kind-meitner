...
export const TEAM_LIBRARY_REPOSITORY = "https://github.com/harrymove-ctrl/kind-meitner-teams";
export const TEAM_LIBRARY_RAW_ROOT = "https://raw.githubusercontent.com/harrymove-ctrl/kind-meitner-teams/main";
...
export function parseTeamCatalog(value: unknown): TeamCatalog {
  if (!isRecord(value) || value.format !== "kind-meitner.catalog" || value.version !== 1) {
