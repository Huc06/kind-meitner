...
// DATA_DIR (~/.kind-meitner) never touches the real one. os.homedir()
...
const home = mkdtempSync(join(tmpdir(), "kind-meitner-test-home-"));
process.env.HOME = home;
process.env.USERPROFILE = home;
// KIND_MEITNER_DATA_DIR is an intentional production override, but tests must never
// let it escape the throwaway home they are about to delete.
delete process.env.KIND_MEITNER_DATA_DIR;
...
process.env.KIND_MEITNER_COMPANION_DIR = join(home, ".kind-meitner-companion");
