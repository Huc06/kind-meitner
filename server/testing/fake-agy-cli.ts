...
//     reads kind-meitner's temporary `kind-meitner-agents` entry from agy's
...
function agentsMcpEntry(): McpEntry | null {
  ...
  try {
    ...
    const entry = config.mcpServers?.["kind-meitner-agents"];
  ...
  return new Promise((resolve, reject) => {
    ...
    write({
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "kind-meitner-fake-antigravity", version: "1.0.0" },
      },
    });
  });
}
