...
/** FTS5 is in every runtime kind-meitner supports — node:sqlite on Node ≥ 24
...
export function describeMissingFts5(error: unknown): Error | null {
  ...
  return new Error(
    `kind-meitner needs SQLite with FTS5, which is built into Node 24 and newer (and into the app). ` +
