...
describe("API onboarding", () => {
  it.each<{
  ...
  }>([
    {
      ...
      environment: { KIND_MEITNER_SETUP_TEST_CUSTOM_KEY: "instance-custom-key", OPENAI_COMPAT_API_KEY: "instance-default-key" },
      processEnvironment: { KIND_MEITNER_SETUP_TEST_CUSTOM_KEY: "process-custom-key", OPENAI_COMPAT_API_KEY: "process-default-key" },
      expected: "config-key",
    },
    {
    ...
    },
    {
      ...
      processEnvironment: { KIND_MEITNER_SETUP_TEST_CUSTOM_KEY: "process-custom-key" },
      expected: "instance-default-key",
    },
    {
      label: "custom process environment fallback",
      processEnvironment: { KIND_MEITNER_SETUP_TEST_CUSTOM_KEY: "process-custom-key" }, expected: "process-custom-key",
    },
    {
    ...
    const original = {
      ...
      config: { url: "https://api.example.test/v1", apiKeyEnv: "KIND_MEITNER_SETUP_TEST_CUSTOM_KEY", ...(configKey ? { key: configKey } : {}) },
    };
