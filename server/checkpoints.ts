...
const EXCLUDES = `# kind-meitner checkpoint excludes — never snapshotted, never removed by restore
.git/
.svn/
.hg/
node_modules/
...
function gitEnv(shadow: string, cwd: string): NodeJS.ProcessEnv {
  ...
  env.GIT_AUTHOR_NAME = "kind-meitner Checkpoint";
  env.GIT_AUTHOR_EMAIL = "checkpoint@kind-meitner.local";
  env.GIT_COMMITTER_NAME = "kind-meitner Checkpoint";
  env.GIT_COMMITTER_EMAIL = "checkpoint@kind-meitner.local";
  return env;
}
