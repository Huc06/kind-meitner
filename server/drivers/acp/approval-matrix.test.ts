...
// These tests prove kind-meitner's flags/settings and handling of residual requests,
...
describe("remaining ACP approval mappings", () => {
  it.each([
    ...
    ensureDirs();
    const scratch = mkdtempSync(join(tmpdir(), "kind-meitner-approval-matrix-"));
    ...
    const instance = await driver.create({
      ...
      environment: {
        ...
        KIND_MEITNER_PROBE_LOCAL_INJECT: "0",
