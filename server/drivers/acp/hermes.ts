...
export const HERMES_KIND_MEITNER_SCREENSHOT_COMPAT = "HERMES_KIND_MEITNER_SCREENSHOT_COMPAT";
export const HERMES_KIND_MEITNER_SCREENSHOT_COMPAT_MODEL = "HERMES_KIND_MEITNER_SCREENSHOT_COMPAT_MODEL";
...
export function bindHermesScreenshotCompat(
  ...
  delete env[HERMES_KIND_MEITNER_SCREENSHOT_COMPAT];
  delete env[HERMES_KIND_MEITNER_SCREENSHOT_COMPAT_MODEL];
  const inject = decodeInjectId(modelId);
  if (!inject) return;
  env[HERMES_KIND_MEITNER_SCREENSHOT_COMPAT] = "1";
  env[HERMES_KIND_MEITNER_SCREENSHOT_COMPAT_MODEL] = inject.model;
}
...
const support: AcpSupport = {
  ...
  resolveTurnModel: (model, env) => {
    ...
    // Only this KindMeitner driver binds one concrete local model; Hermes still
