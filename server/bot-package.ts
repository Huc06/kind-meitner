...
export const BOT_PACKAGE_FORMAT = "kind-meitner.package" as const;
...
const packageSchema = z.object({
  format: z.literal(BOT_PACKAGE_FORMAT, { error: "This is not an KindMeitner package" }),
 ...
 * run without kind-meitner or another proprietary parser. */
