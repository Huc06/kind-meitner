...
// reads KIND_MEITNER_DATA_DIR at import time — so point the suite at a scratch dir
...
// KIND_MEITNER_DATA_DIR is set by the harness. Here we isolate by botId.
...
beforeEach(() => {
  scratch = mkdtempSync(join(tmpdir(), "kind-meitner-skills-"));
  process.env.KIND_MEITNER_TEST_UNUSED = scratch; // keep cleanup symmetrical
