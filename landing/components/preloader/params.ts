...
export const SENTENCES: SentenceSpec[] = [
  ...
  {
    words: ["kind", "meitner", "is", "the", "identity", "layer"],
    burst: 4,
    theme: {
  ...
  /* The workspace claim: a name is evidence about an agent, checked at runtime in
     both directions, not a label anyone can assert. */
  {
    words: ["the", "workspace", "guides", "the", "agent"],
    burst: 2,
    theme: {
  ...
  {
    words: ["grant", "one", "agent", "not", "everything"],
    burst: 2,
    theme: {
  ...
  {
    words: ["one", "team", "guided", "by", "people"],
    burst: 2,
    theme: {
