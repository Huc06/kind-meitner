...
const title = "Kind Meitner — the identity layer";
const description =
  "I would make Kind Meitner the identity layer, then choose partners that naturally become the data and execution layers.";
