...
const service: ServiceInfo = {
  ...
  type: "_kind-meitner._tcp",
  port: 8800,
  host: "kind-meitner-1a2b3c4d.local",
  addresses: ["192.168.1.42"],
  txt: ["v=1", "name=Milind's computer"],
};

const INSTANCE = "Milind's computer._kind-meitner._tcp.local";
const SERVICE_NAME = "_kind-meitner._tcp.local";
