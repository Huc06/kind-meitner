...
// ~/.kind-meitner would be reaching into somebody else's data layout — the
...
/** KIND_MEITNER_COMPANION_DIR isolates a test rig from a real paired fleet. */
export const DATA_DIR = process.env.KIND_MEITNER_COMPANION_DIR ?? join(homedir(), ".kind-meitner-companion");
